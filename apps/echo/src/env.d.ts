...
type _CoercedEnvSchema_f02015a4 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_f02015a4> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_f02015a4, 'HOST' | 'PORT' | 'MAX_ECHO_TEXT_LENGH'>> {}
}
...
type _EnvSchemaAsStrings_f02015a4 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_f02015a4 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_f02015a4 {}
  }
}