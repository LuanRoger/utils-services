...
type _CoercedEnvSchema_817711ba = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_817711ba> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_817711ba, 'APP_ENV' | 'HOST' | 'PORT'>> {}
}
...
type _EnvSchemaAsStrings_817711ba = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_817711ba {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_817711ba {}
  }
}