...
type _CoercedEnvSchema_5a0a0661 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_5a0a0661> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_5a0a0661, 'APP_ENV' | 'HOST' | 'PORT' | 'RATE_LIMIT_DURATION' | 'RATE_LIMIT_MAX'>> {}
}
...
type _EnvSchemaAsStrings_5a0a0661 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_5a0a0661 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_5a0a0661 {}
  }
}